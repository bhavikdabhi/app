...
// Fetch 3 random records from the database
$sql = "SELECT id, image_data, country, place, description, pdf FROM images ORDER BY RAND() LIMIT 3";
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $imageSrc = "./upload/display_image.php?id=" . $imageId;
        echo "
        <li>
            <div class='popular-card'>
                <figure class='card-img'>
                    <img src='$imageSrc' alt='$place' loading='lazy'>
                </figure>
...
// Fetch 3 random records from the database
$sql = "SELECT id, image_data, country, place, description, pdf ,day,night,pax,price FROM images ORDER BY RAND() LIMIT 3";
$result = mysqli_query($conn, $sql);
